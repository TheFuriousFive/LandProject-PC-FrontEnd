...
import { Grid2X2, Plus, Activity, Home, User } from "lucide-react";
...
export default function Sidebar() {
  ...
  const navLinks = [
    ...
    { href: "/owner/lists", label: "My Ads", icon: Grid2X2 },
    { href: "/owner/add-land", label: "Add New Land", icon: Plus },
    { href: "/owner/logs", label: "Activity Logs", icon: Activity },
